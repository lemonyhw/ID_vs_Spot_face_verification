...
parser.add_argument('--classifier_type', type=str, default='AL', help='Which classifier for train. (MCP, AL, L,ARC,TRIP,DUM)')
...
parser.add_argument('--save_path', type=str, default='./models/checkpoint_NJN_RP_AL_npair_1/',help='path to save checkpoint')
