...
from utils.dataset import NImageList
from utils.evaluate_prototype import eval
from utils.layer import  NpairLoss
import json
...
parser.add_argument('--train_list', type=str, default="./Data/NJN_Random_prototype_train_300000.json",help='path to training list')
...
parser.add_argument('--pre_model', type=str,default="./models/checkpoint_NJN_Npairloss/24.pth",
                    help='Which network for train. (sphere20, sphere64, LResNet50E_IR)')
...
parser.add_argument('--save_path', type=str, default='./models/checkpoint_NJN_Npairloss/',help='path to save checkpoint')
...
def main():
    ...
    train_loader = torch.utils.data.DataLoader(
        NImageList(root=args.train_root, train_root=train_list, train_label=train_label,
